...
const regions = [
  { name: "Shanghai", v: 92 },{ name: "Beijing", v: 78 },{ name: "Shenzhen", v: 71 },
  { name: "Hangzhou", v: 64 },{ name: "Chengdu", v: 51 },{ name: "Guangzhou", v: 47 },
];
const keywords = [
  { k: "玻璃肌", v: "+42%" },{ k: "成分党", v: "+38%" },{ k: "韩系护肤", v: "+27%" },
  { k: "早C晚A", v: "+19%" },{ k: "纯净护肤", v: "+14%" },{ k: "敏感肌", v: "+11%" },
];
    ...
    <div>
      ...
      <div className="space-y-8">
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {[
            { label: t("market.kpi.tam"), value: "¥48.2B", sub: "K-beauty · 2026E" },
            { label: t("market.kpi.yoy"), value: "+18.4%", sub: "Tmall + Xiaohongshu" },
            { label: t("market.kpi.tier1"), value: "62%", sub: "Share of demand" },
            { label: t("market.kpi.basket"), value: "¥384", sub: "Premium tier" },
          ].map((s) => (
        ...
        <div className="grid gap-4 lg:grid-cols-3">
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--background)] p-6 shadow-[var(--shadow-soft)] lg:col-span-2">
            <div className="mb-4 flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-[var(--muted-foreground)]">{t("market.growth.sub")}</p>
              </div>
          ...
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--background)] p-6 shadow-[var(--shadow-soft)]">
            <div className="mb-4 flex items-center gap-2"><Flame className="h-4 w-4 text-[var(--primary)]" /><h3 className="text-sm font-semibold">{t("market.keywords")}</h3></div>
        ...
        <div className="rounded-2xl border border-[var(--border)] bg-[var(--background)] p-6 shadow-[var(--shadow-soft)]">
          <div className="mb-4 flex items-center gap-2"><MapPin className="h-4 w-4 text-[var(--primary)]" /><h3 className="text-sm font-semibold">{t("market.regions")}</h3></div>
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
